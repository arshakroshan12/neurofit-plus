...
from pathlib import Path
# allow all origins for demo only — tighten in production
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
